...
<form runat="server" ID="LoginForm" method="post">
  ...
  <tr>
    ...
    <td class="XPWindowFoot"><a href="http://anmar.eu.org/projects/sharpwebmail/" class="XPWindowFoot" target="_blank"><%=Application["product"]%></a> - Copyright &copy; 2003-2005 <a href="http://anmar.eu.org" class="XPWindowFoot" target="_blank">Angel Marin</a></td>
